...
public class Vertex {
  ...
  public static Vertex[] newVertices(int count) {
  ...
  public static Vertex[] createQuad(float[] loc, float[] tex, float[] col) {
  ...
  public static Vertex[] createBorder(float[] loc, float[] col) {
  ...
  public static Vertex[] createLine(float[] loc1, float[] loc2, float[] col) {
